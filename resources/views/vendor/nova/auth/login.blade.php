...
<form
    class="bg-black shadow rounded-lg p-8 max-w-login mx-auto text-warning"
    method="POST"
...
>
    ...
    <div class="flex mb-6">
        ...
        <div class="ml-auto">
            <a class="text-warning dim font-bold no-underline" href="{{ route('nova.password.request') }}">
    ...
    <button class="w-full btn btn-default bg-warning dim" type="submit">
        {{ __('Login') }}
    </button>
</form>
@endsection
