    ...
    <div id="nova">
        <div v-cloak class="flex min-h-screen">
            ...
            <div class="min-h-screen flex-none pt-header min-h-screen w-sidebar bg-grad-sidebar px-6">
                <a href="{{ Nova::path() }}">
                    <div class="absolute pin-t pin-l pin-r bg-logo flex items-center w-sidebar h-header px-6 text-white" style="height: auto;">
                       @include('nova::partials.logo', ['width' => '150', 'height' => '75'])
                    </div>
                </a>
